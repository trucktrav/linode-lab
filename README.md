# ✨ MANS ✨ — TruckTrav Labs' NAS Creator

Thanks to Muffin's Awesome NAS Stack for getting this project started!

cant run snapraid as user without these permissions
todo: /var/snapraid/snapraid permission
todo: /mnt/parity-disks/parity permission
...
mans_host:
  hosts:
    hht-fs01:
      ansible_host: hostname.localserver.lan
